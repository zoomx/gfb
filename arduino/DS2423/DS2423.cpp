...
ds2423::ds2423(OneWire* _oneWire, uint8_t* deviceAddress)
{
  _wire = _oneWire;
...
bool ds2423::writeMem(uint8_t* _memPage, int _pageSize, uint8_t _TA1, uint8_t _TA2)
{
...
void ds2423::readMem(uint8_t* _memAll, uint8_t _TA1, uint8_t _TA2)
{
  uint8_t tmpReader;
  bool readFF = 0;
