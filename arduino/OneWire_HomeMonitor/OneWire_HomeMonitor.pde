...
// Setup oneWire networkA (was pin4)
OneWire oneWireA(6);
DallasTemperature sensorsA(&oneWireA);

// Setup oneWire networkB - switched network (was pin 6)
OneWire oneWireB(7);
...
void setup()
{
  ...
  T2 = { 0x28, 0xED, 0x89, 0x87, 0x02, 0x00, 0x0, 0x55 }; //decomissioned
  T3 = { 0x28, 0xED, 0x89, 0x87, 0x02, 0x00, 0x0, 0x55 }; //Master Bed
  T4 = { 0x10, 0x65, 0x37, 0xFA, 0x01, 0x08, 0x0, 0xB1 };
//  T5 = { 0x28, 0xF5, 0x05, 0x06, 0x02, 0x00, 0x0, 0x13 }; //old arduino local - netA
  T5 = { 0x28, 0x22, 0x8E, 0x87, 0x02, 0x00, 0x0, 0xBF }; //Utility room
  T6 = { 0x28, 0xEB, 0xC9, 0x0E, 0x02, 0x00, 0x0, 0x44 }; //thermostat - netA
  T7 = { 0x28, 0x3B, 0xD1, 0x87, 0x02, 0x00, 0x0, 0x88 }; //arduino local - netA
...
//  sensorsA.requestTemperatures();
  ...
  //do arduino onboard
  sensorsA.setResolution(T7, REZ);
  sensorsA.requestTemperaturesByAddress(T7);
  T7temp = sensorsA.getTempF(T7);
...
void runNetworkB()
{
  ...
  sensorsB.setResolution(T5, REZ);
  sensorsB.requestTemperaturesByAddress(T5);
  T5temp = sensorsB.getTempF(T5);
